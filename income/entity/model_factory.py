...
def get_evulated_classification_model(model_list:list,X_train:np.ndarray,y_train:np.ndarray,X_test:np.ndarray,
    ...
    try:
        ...
        for model in model_list:
            ...
            logging.info(f"difference in train and test accuracy is : {diff_train_test_accuracy}")
...
class ModelFactory:
    ...
    def get_intlized_model_list(self):
        try:
            ...
            for model_serial_number in self.model_intial_config.keys():
                ...
                model_config = InitlizedModelDetails(model=model,model_serial_number=model_serial_number,
                                                     params_grid_search=params_grid_search,model_name=model_name)
        ...
        try:
            ...
            for intlized_model in intlized_model_list:
                ...
                grid_searched_best_model = self.initite_best_parameter_search_for_initlized_model(
                    intilized_model_detials=intlized_model,
    ...
    def initite_best_parameter_search_for_initlized_model(self,intilized_model_detials:InitlizedModelDetails,
                                                          input_feature,output_feature)->GridSearchedBestModel:
        try:
            logging.info(f"finding best parametere for each models")
            ...
            grid_search_cv = grid_search_ref(estimator=intilized_model_detials.model,
                                            param_grid =intilized_model_detials.params_grid_search)
            ...
            grid_searched_best_model = GridSearchedBestModel(model_serial_number=intilized_model_detials.model_serial_number,
                                                             model=intilized_model_detials.model,
    ...
    @staticmethod
    def get_best_model_from_grid_serached_best_model_list(grid_search_best_model_list: List[GridSearchedBestModel],
    ...
    def get_best_model(self,X,y,base_accuracy=0.6):
        try:
            ...
            return ModelFactory.get_best_model_from_grid_serached_best_model_list(grid_search_best_model_list=grid_searched_best_model_list,
